...
- **Part 1**: Due at midnight on Saturday, February 7, 2026 [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203153)

- **Part 2**: Due at midnight on Saturday, February 14, 2026 [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203154)
...
atlas_wisconsin <- atlas_wisconsin %>%
  mutate(
    kfr_pooled_p25_std = (kfr_pooled_p25 - mean(atlas_wisconsin$kfr_pooled_p25, na.rm = TRUE)) / sd(atlas_wisconsin$kfr_pooled_p25, na.rm = TRUE),
...
``` {r, eval=FALSE}
ggplot(data = atlas_milwaukee) +
  geom_point(aes(x = xvar1, y = yvar)) +
