...
s_geomob <- c(
  ...
  "[Chetty, Friedman, Hendren, Jones and Porter (2018)-<br>**Non-technical summary**](https://utsa.instructure.com/courses/79928/files?preview=13165235) ", # reading
  " ", # method
  " "
) # deliverable
...
s_introR2 <- c(
  ...
  " ", # reading
  " ", # method
  "First short report (In class) - [Project 0](#project0) ([Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203152))"
) # deliverable
...
s_causaleffects <- c(
  ...
  "[Bergman, Chetty, DeLuca, Hendren, Katz and Palmer (2019) -<br>Non-technical summary](https://utsa.instructure.com/courses/79928/files?preview=13165236) ", # reading
...
s_causaleffects2 <- c(
  ...
  "[Bergman, Chetty, DeLuca, Hendren, Katz and Palmer (2019) -<br>Introduction](https://utsa.instructure.com/courses/79928/files?preview=13165238) ", # reading
  "Quasi-experiments ", # method
  "[Project 1](#project1) – Part 1 (for Saturday 02/07) [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203153)"
) # deliverable
...
s_mob_hist_int <- c(
  ...
  " ", # reading
  " ", # method
  "[Project 1](#project1) – Part 1 and 2 (for Saturday 02/14) [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203154)"
) # deliverable
...
s_mob_ed <- c(
  ...
  "[Dynarski, Libassi, Michelmore and Owen (2018)](https://utsa.instructure.com/courses/79928/files?preview=13165240)", # reading
...
s_recap_quarto <- c(
  ...
  " ", # reading
  " ", # method
  "[Project 2](#project2) (Saturday 03/07) [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203158) "
) # deliverable
...
s_k12 <- c(
  ...
  "[Chetty, Friedman and Rockoff (2011)-<br>Non-technical summary](https://utsa.instructure.com/courses/79928/files?preview=13165241)	", # reading
  "Experiments ", # method
  " "
) # deliverable
s_teachers <- c(
...
s_racedis <- c(
  ...
  "[Bertrand, and Mullainathan (2004)](https://utsa.instructure.com/courses/79928/files?preview=13165242)	", # reading
...
s_jud_sys <- c(
  ...
  "[Kleinberg, Lakkaraju, Leskovec, Ludwig and Mullainathan (2017)-<br>Non-technical summary](https://utsa.instructure.com/courses/79928/files?preview=13165687) ", # reading
...
s_immigration <- c(
  ...
  "[Tabellini (2020)](https://utsa.instructure.com/courses/79928/files?preview=13165933)  ", # reading
...
s_ml2 <- c(
  ...
  "  ", # reading
  "  ", # method
  "[Project 3](#project3) (for Saturday 04/11) [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203200)"
) # deliverable
s_ml3 <- c(
  "13: 04/14", # date
  "22", # session
...
s_tax <- c(
  ...
  "[Diamond and Saez (2011)](https://utsa.instructure.com/courses/79928/files?preview=13165247)  ", # reading
...
s_pollution <- c(
  ...
  "[Isen, Rossin-Slater, and Walker (2017)-<br>Non-technical summary](https://utsa.instructure.com/courses/79928/files?preview=13167967)", # reading
  "Difference in difference ", # method
  "[Project 4](#project4) - (for Saturday 04/25) [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203213)"
) # deliverable
...
s_final <- c(
  "16: 05/12", # date
  "-", # session
  "**Final Exam at 1 pm** ", # topic with link
  " ", # reading
  " ", # method
  ""
) # deliverable
