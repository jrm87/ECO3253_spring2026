...
If you are unable to render to PDF and receive an error related to LaTeX, you may need to install `tinytex`. Run the following commands in your Console:
...
This will install a lightweight LaTeX distribution needed to create PDF documents. 
