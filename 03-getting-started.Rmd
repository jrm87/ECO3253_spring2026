...
If you want to use Posit Cloud, you need to tell me in advance and I will send out the invite. If you would still like to install R and RStudio in your own computer, please follow the instructions in Section 1.1.1 in this [link](https://nulib.github.io/moderndive_book/1-getting-started.html). Of course, you are encouraged to experiment in your own machine as well. Notice, however, that you should carry out the assignments and projects in Posit Cloud. 
...
You can use either method, but regardless of which one you choose, homework and projects should be uploaded as pdf to Canvas.
::::

### Installing R and RStudio Locally

If you prefer to work locally, you will need to install both R and RStudio.

1.  **Install R**: Go to the [CRAN website](https://cran.r-project.org/) and download the version of R appropriate for your operating system (Windows, Mac, or Linux).
2.  **Install RStudio**: Go to the [Posit website](https://posit.co/download/rstudio-desktop/) and download the free RStudio Desktop version.

Once installed, open RStudio to begin. You will need to install the necessary packages as described in the [Package installation](#package-installation) section.
